...
public class Servlet_MP extends HttpServlet {
    ...
    private void RegistrarMarcaProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("mensaje.jsp?mens='Se ha registrado una marca correctamente'"); 
        }else{
            response.sendRedirect("mensaje.jsp?mens='Error al registrar la marca '"); 
        }
    }
    ...
    private void ActualizarMarcaProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("mensaje.jsp?mens='Se ha modificado la marca "+mp.getCodigoMP()+"'"); 
        }else{
            response.sendRedirect("mensaje.jsp?mens='Error al modificar la marca seleccionada'"); 
        }
    }
    ...
    private void darBajaMarcaProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("mensaje.jsp?mens='Se ha eliminado la marca "+mp.getCodigoMP()+"'"); 
        }else{
            response.sendRedirect("mensaje.jsp?mens='Error al eliminar la marca seleccionada'"); 
        }
    }
    ...
    private void darAltarMarcaProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("mensaje.jsp?mens='Se ha recuperado la marca "+mp.getCodigoMP()+"'"); 
        }else{
            response.sendRedirect("mensaje.jsp?mens='Error al recuperar la marca seleccionada'"); 
        }
    }
