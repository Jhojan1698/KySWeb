        ...
        if(resp){
            ...
            for(int i=0; i<NombreProducto.length;i++){
                try{
                    ...
                    if(j==1){
                        response.sendRedirect("mensaje2.jsp?mens='Se ha registrado su compra correctamente, el pedido sera enviado a su domicilio. Recuerde que el pago es contraentrega. "
                                + "Muchas Gracias por su Compra'"); 
                        lista.clear();
                    }else{
                        response.sendRedirect("mensaje2.jsp?mens='Error al registrar su compra. Introdusca productos al carrito!!'");
                    }
