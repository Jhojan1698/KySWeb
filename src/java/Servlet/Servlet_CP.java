...
public class Servlet_CP extends HttpServlet {
    ...
    private void RegistrarClaseProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("mensaje.jsp?mens='Se ha registrado una categoria correctamente'");
        }else{
            response.sendRedirect("mensaje.jsp?mens='Error al registrar en la categoria'"); 
        }
    }
    ...
    private void ActualizarClaseProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("mensaje.jsp?mens='Se ha modificado la categoria "+cp.getCodigoCP()+"'");
        }else{
            response.sendRedirect("mensaje.jsp?mens='Error al actualizar la categoria'");
        }
    }
    ...
    private void EliminarClaseProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("mensaje.jsp?mens='Se ha eliminado la categoria "+cp.getCodigoCP()+"'");
        }else{
            response.sendRedirect("mensaje.jsp?mens='Error al eliminar la categoria'");
        }
    }
    ...
    private void RecuperarClaseProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if(resp){
            response.sendRedirect("mensaje.jsp?mens='Se ha recuperado la categoria "+cp.getCodigoCP()+"'");
        }else{
            response.sendRedirect("mensaje.jsp?mens='Error al recuperar la categoria'");
        }
    }
