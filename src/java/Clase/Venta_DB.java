...
public class Venta_DB {
    ...
    public static ArrayList<Venta> ReporteComprasdeCliente(String nombre, String apellido){
        ArrayList<Venta> lista = new ArrayList<Venta>();
        Connection cn;
        Conexion con = new Conexion();
        cn=con.conectar();
        ...
        try{
            CallableStatement cs = cn.prepareCall("CALL REPORTE_COMPRAS_POR_CLIENTE(?,?)");
        ...
        public static ArrayList<Venta> ReporteporFecha(String fecha1, String fecha2){
        ArrayList<Venta> lista = new ArrayList<Venta>();
        Connection cn;
        Conexion con = new Conexion();
        cn=con.conectar();
        ...
        try{
            CallableStatement cs = cn.prepareCall("CALL REPORTE_VENTA_POR_FECHAS(?,?)");
