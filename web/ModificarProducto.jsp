...
<html>
    <head>
        ...
        <title>Modificar Producto KyS</title>
    </head>
    ...
    <body onload="cargar()">
        <form name="frm" action="Servlet_Prod" method="post" id="frmModificarProd">
            <table id="tablaModificarProd">
                <tr>
                    <th colspan="2">
                        <h1>MODIFICAR DATOS DE PRODUCTO</h1>
                    </th>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <td>
                        <dd> <input type="text" name="txtDescripcionP" id="txtDescripcionP" value="<%=p.getDescripcion() %>" size="30" maxlength="200"> </dd>
                    </td>
                </tr>
                <tr>
                    <td class="primeraColumna">
