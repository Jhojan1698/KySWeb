...
<html>
    <head>
        ...
        <title>Detalle de venta KyS</title>
        <style>
            @media print{
                .boton01, .boton02 {
                    display: none;
    ...
    <body>
        <form action="Servlet_Prod" method="post" id="frmMostrarDetalleVenta">
            ...
            <table id="tablaRegresar">
                ...
                <tr>
                    <td>
                        <a href="MostrarVenta.jsp" class="link boton01">REGRESAR</a>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <form id="frmMostrarDatosCliente">
                        ...
                        <table id="tablaMostrarDatosCliente">
                            ...
                            <tr>
                                <td>
                                  <input type="button" name="btnEmitirboleta" id="btnEmitirBoleta" class="button boton02" onclick="print()" value="Emitir Boleta">    
                                </td>
                            </tr>
                        </table>
                    </form>            
