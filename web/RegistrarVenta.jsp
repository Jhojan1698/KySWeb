...
<html>
    <head>
        ...
        <title>Carrito de Compras KyS</title>
        <style>
            @media print{
                .parte01, .parte02, .Opcion, .parte03{
                    display: none;
                }
            }
        </style>
        ...
        <form action="Servlet_Venta" method="post" id="frmRegistrarVenta">
            ...
            <table id="tablaRegistrarVenta">
                ...
                <tr>
                    ...
                    <table id="tablaRegresar" class="parte01">
                <tr>
                    <td>
                        <br>
                    </td>
                ...
                <tr>
                    <td>
                        <input type="button" name="btnEmitirboleta" id="btnEmitirBoleta" class="button" onclick="print()" value="Emitir Boleta">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <input type="button" name="btnRegistrar" id="btnRegistrarVenta" class="button" value="Realizar envio">
                    </td>
                </tr>
                <tr>
                    <td>
