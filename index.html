    ...
    <body onload="cargar()">
        ...
        <form action="Servlet_Usu" method="post" id="frmCabecera">
            ...
            <table id="tablaCabecera">
                ...
                <tr>
                    <td>
                        <a href="Nosotros.jsp" class="link" id="lnkNosotros"><h4>Nosotros</h4></a>
                    </td> 
                    <td>
                        <a href="RegistrarVenta.jsp" class="link" id="lnkCompra"><h4>Carrito de Compras</h4></a>
                    </td>
                    <td>
        ...
        <form id="frmCatalogo">
            ...
            <table width="800" id="tablaCatalogo">
                ...
                <%
                    ...
                    if(nombuscar!=null){
                        Producto a = Producto_DB.listarProductoPorNombre(request.getParameter(nombuscar));   
                    }else{
                ...
                %>
                            ...
                            <input type="button" class="BotonADD" name="btnADD" value="Añadir a Carrito" onclick="location.href='AnadirCarrito.jsp?codigoP=<%=p.getCodigoP()%>&&cliente=<%=cliente %>'"><br>
                            </th>
                <%
                        salto++;
                        if(salto == 3){
